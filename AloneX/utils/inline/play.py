...
#bar of wynk---------------------------------------
    if 0 < alone <= 1:
        bar = "𝐀ℓσиє 𝐌υѕι¢ 𝐀ℓσиє 𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
    elif 1 <= alone < 2:
        bar = "𝐀ℓσиє 𝐌υѕι¢ 𝐅α𝗏ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 2 <= alone < 3:
        bar = "𝐀ℓσиє 𝐌𝗂ᥣᥣ𝗂ⱺ𐓣 𝐒ⱺ𐓣𝗀𝗌"
    elif 3 <= alone < 4:
        bar = "𝐀ℓσиє 𝐄α𝗌𝗂ᥣ𝗒 𝐒𝗍𝗋𝖾αꭑ"
    elif 4 <= alone < 5:
        bar = "𝐀ℓσиє 𝐋ⱺω-𝐒ρ𝖾𝖾ᑯ 𝐒𝗍𝗋𝖾αꭑ𝗂𐓣𝗀"
    elif 5 <= alone < 6:
        bar = "𝐀ℓσиє 𝐁𝗂𝗀 𝐃α𝗍αᑲα𝗌ɦ"
    elif 6 <= alone < 7:
        bar = "𝐅𝗋𝖾𝖾 𝐃ⱺω𐓣ᥣⱺαᑯ 𝐀ℓσиє 𝐌υ𝗌𝗂𝖼"
    elif 7 <= alone < 8:
        bar = "𝐀ℓσиє 𝐌υѕι¢ 𝐅α𝗏ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 8 <= alone < 9:
        ...
        bar = "𝐀ℓσиє 𝐒ⱺ𐓣𝗀 𝚰𝗌 𝐀ᑲⱺυ𝗍 𝐓ⱺ 𝐄𐓣ᑯ"
    elif 46 <= alone < 47:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐀ℓσиє 𝐌υѕι¢ 𝐀ρρ 𝐎𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ"
    elif 47 <= alone < 48:
        bar = "𝐀ℓσиє 𝐒ⱺ𐓣𝗀 𝚰𝗌 𝐀ᑲⱺυ𝗍 𝐓ⱺ 𝐄𐓣ᑯ"
    elif 48 <= alone < 49:
        bar = "𝐀ℓσиє 𝐓ɦ𝖾 𝐒ⱺ𐓣𝗀 𝚰𝗌 𝐎𝗏𝖾𝗋"
    elif 49 <= alone < 50:
        bar = "𝐀ℓσиє 𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
    elif 50 <= alone < 51:
        bar = "𝐀ℓσиє 𝐌𝗂ᥣᥣ𝗂ⱺ𐓣 𝐒ⱺ𐓣𝗀𝗌"
